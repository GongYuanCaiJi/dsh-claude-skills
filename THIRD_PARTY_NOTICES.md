...
| Marketplace version | `2.9.0` (`.claude-plugin/marketplace.json`) |
...
| SHA-256 | File |
|---|---|
| `ee6ffd75e19eaf1b8b729c6c401fb27c1b24d62f33afafc281669f2819128867` | `README.md`（上游原檔，見下方「替代」說明） |
| `a20126646f93d32a8989c3cf4772d59194f405034f7babe7daebeac22b8ab151` | `LICENSE`（上游原檔，見下方「替代」說明） |
